...
These terms of service outline the rules and regulations for the use of Daisushi's Website.

By accessing this website we assume you accept these terms of service in full. Do not continue to use Daisushi's website if you do not accept all of the terms of service stated on this page.
...
We employ the use of cookies. By using Daisushi's website you consent to the use of cookies in accordance with Daisushi's privacy policy.

Most of the modern day interactive web sites use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site to enable the functionality of this area and ease of use for those people visiting. Some of our affiliate / advertising partners may also use cookies.

## License

Unless otherwise stated, Daisushi and/or it's licensors own the intellectual property rights for all material on Daisushi. All intellectual property rights are reserved. You may view and/or print pages from dai.sushi for your own personal use subject to restrictions set in these terms of service.

You must not:

1.  Republish material from dai.sushi
2.  Sell, rent or sub-license material from dai.sushi
3.  Reproduce, duplicate or copy material from dai.sushi

Redistribute content from Daisushi (unless content is specifically made for redistribution).
...
We will approve link requests from these organizations if we determine that: (a) the link would not reflect unfavorably on us or our accredited businesses (for example, trade associations or other organizations representing inherently suspect types of business, such as work-at-home opportunities, shall not be allowed to link); (b)the organization does not have an unsatisfactory record with us; (c) the benefit to us from the visibility associated with the hyperlink outweighs the absence of Daisushi; and (d) where the link is in the context of general resource information or is otherwise consistent with editorial content in a newsletter or similar product furthering the mission of the organization.

These organizations may link to our home page, to publications or to other Web site information so long as the link: (a) is not in any way misleading; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and it products or services; and (c) fits within the context of the linking party's site.

If you are among the organizations listed in paragraph 2 above and are interested in linking to our website, you must notify us by sending an e-mail to [contact@dai.sushi](mailto:contact@dai.sushi "send an email to contact@dai.sushi"). Please include your name, your organization name, contact information (such as a phone number and/or e-mail address) as well as the URL of your site, a list of any URLs from which you intend to link to our Web site, and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response.
...
No use of Daisushi's logo or other artwork will be allowed for linking absent a trademark license agreement.
